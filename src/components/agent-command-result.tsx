    ...
    >
      ...
      {result.sources.length > 0 ? (
        <section aria-labelledby={sourcesTitleId} className="mt-5 border-t border-slate-100 pt-4">
          <h3 id={sourcesTitleId} className="text-sm font-semibold text-slate-900" aria-label="Источники">
            Источники
          <InfoHint title="Источники" /></h3>
...
function AnalyticalDetails({ analysis }: { analysis: PublicAgentAnalysisSummary }) {
  return (
    <section aria-label="Доказательная аналитика" className="mt-5 space-y-4 border-t border-slate-100 pt-4">
      <div>
        <h3 className="text-sm font-semibold text-slate-950" aria-label="Подтверждённые факты">Подтверждённые факты<InfoHint title="Подтверждённые факты" /></h3>
      ...
      {analysis.drivers.length > 0 ? (
        <div>
          <h3 className="text-sm font-semibold text-slate-950" aria-label="Главные факторы">Главные факторы<InfoHint title="Главные факторы" /></h3>
      ...
      {analysis.scenarios.length > 0 ? (
        <div>
          <h3 className="text-sm font-semibold text-slate-950" aria-label="Сравнение вариантов">Сравнение вариантов<InfoHint title="Сравнение вариантов" /></h3>
