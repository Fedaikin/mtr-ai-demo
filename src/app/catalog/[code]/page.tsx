      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        <div className="space-y-5">
          <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <h2 className="text-base font-semibold text-slate-950" aria-label="Характеристики позиции">Характеристики позиции<InfoHint title="Характеристики позиции" /></h2>
            ...
            <h3 className="mt-7 text-sm font-semibold text-slate-950" aria-label="Параметры совместимости">Параметры совместимости<InfoHint title="Параметры совместимости" /></h3>
          ...
          {bom ? (
            <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-5 py-4"><p className="text-xs font-semibold uppercase tracking-wide text-slate-500">BOM</p><h2 className="mt-1 text-lg font-semibold" aria-label="Состав сборочного узла">Состав сборочного узла<InfoHint title="Состав сборочного узла" /></h2><p className="mt-1 text-sm text-slate-500">{bom.components.length} компонентов</p></div>
        ...
        <aside className="space-y-5">
          <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Суммарный свободный остаток<InfoHint title="Суммарный свободный остаток" /></p>
          ...
          <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-200 px-5 py-4"><h2 className="text-base font-semibold" aria-label="Остатки по складам">Остатки по складам<InfoHint title="Остатки по складам" /></h2></div>
